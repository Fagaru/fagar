...
const CorporationPage = () => {
    ...
    return (
        <div className='m-6'>
            ...
            {corporation && (
                <>
                    <div className="grid xl:grid-cols-4 lg:grid-cols-4 md:grid-cols-1 gap-5 p-2 auto-rows-[minmax(50px,auto)]">
                    {corporation.images.length >= 0 && (
                        <>
                    ...
                    {corporation.images.length < 0 && (
                        <>
                            <div className="row-span-1 col-span-4 p-5 max-h-30 maw-w-30 rounded-[10px]">
                                <div className="aspect-square relative w-full h-full rounded-lg overflow-hidden">
                                        <Image 
                                            fill
                                            src="/default_image.jpg"
                    ...
                    <div className="grid xl:grid-cols-3 lg:grid-cols-2 md:grid-cols-1 gap-5 p-2 auto-rows-[minmax(100px,auto)]">
                        <div className="p-5 row-span-1 col-span-2 rounded-[10px] border-solid border-y-[1px] h-25">
                            ...
                            <div className="pt-2 flex items-center">
                                ...
                                <span className='font-medium'>{corporation.name}</span>
                            </div>
                            <span className='ml-10 font-light text-sm'>{corporation.description} Restaurant</span>
                        </div>
                        ...
                        <div className="flex items-center p-5 row-span-1 col-span-2 rounded-[10px] border-solid border-y-[1px]">
                            <div className='flex items-center'>
                                ...
                                <span className='font-medium pr-10'>Engagé pour l'environnement</span>
                            </div>
                            <div className='pl-10'>
                                <ReviewSection stars={4} rating_mode="read-only" />
                            </div>
                            <div className='pl-15'>
                            <span className='font-medium pl-20'>120 commentaires</span>
                            </div>
                        </div>
